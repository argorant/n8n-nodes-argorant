...
function queryFilters() {
    return {
        ...
        options: FILTER_FIELDS.map((f) => ({
            ...f,
            routing: { send: { type: 'query', property: f.name } },
        })),
    };
}
class Argorant {
    constructor() {
        this.description = {
            ...
            description: 'Search, count, reveal, and export verified B2B contacts — 614M records, 184 countries, verified at export time',
            ...
            properties: [
                ...
                },
                {
                    ...
                    options: FILTER_FIELDS.map((f) => ({
                        ...f,
                        routing: { send: { type: 'body', property: `filters.${f.name}` } },
                    })),
                },
                {
                    displayName: 'Job ID',
